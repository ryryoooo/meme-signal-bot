...
MAP = {
    ...
    "DISCORD_STONKFUN_WEBHOOK_URL": ("card", "DISCORD_STONKFUN_WEBHOOK_URL"),
    "DISCORD_SOL_SMART_WEBHOOK_URL": ("card", "DISCORD_SOL_SMART_WEBHOOK_URL"),
    "DISCORD_SOL_PAPER_WEBHOOK_URL": ("card", "DISCORD_SOL_PAPER_WEBHOOK_URL"),
