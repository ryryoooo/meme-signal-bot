...
export COOLDOWN_SECONDS="${COOLDOWN_SECONDS:-300}"
...
export_onchain_env() {
  ...
  export COOLDOWN_SECONDS="${COOLDOWN_SECONDS:-300}"
  export NOTIFY_MARKET_SOURCE="${NOTIFY_MARKET_SOURCE:-dex}"
  export GMGN_MARKET="${GMGN_MARKET:-0}"
  export MIN_WALLETS="${MIN_WALLETS:-2}"
  export DROP_WEAK_WALLETS=0
  export DROP_BOT_WALLETS=0
  export PRIORITY_NOTIFY="${PRIORITY_NOTIFY:-1}"
  export PRIORITY_MIN_WALLETS="${PRIORITY_MIN_WALLETS:-3}"
  export MIN_CLUSTER_PRIORITY="${MIN_CLUSTER_PRIORITY:-150}"
  export LIQ_REQUIRED=0
  export ANTI_SPIKE_REQUIRED=0
  export RH_SOFT_GATES=1
  export REQUIRE_PRICE_MOVE=0
