...
| INACTIVE | **2533** | 直近証拠なし / 未vet |
| QUALITY 優良 | **233** | WR≥0.5 + PnL≥1000 + n≥20 |
| WEAK | **7** | 低WR / 弱いPnL / ワンショット |

## Data coverage（どの指標か明示）

- `win_rate` filled: **296/2975** (9.9%)
- `realized_pnl*` filled: **442/2975** (14.9%)
- `n_trades*` filled: **296/2975**
- `*_7d` WR filled: **4/2975** (0.1%) ← GMGN 7d 未充足なら lifetime で判定
- `n_trades_7d` filled: **4/2975**
- `last_active*` filled: **0/2975**
- activity_metric breakdown: `{"lifetime_proxy": 438, "n_trades_7d": 4, "unvetted_proxy": 2533}`
