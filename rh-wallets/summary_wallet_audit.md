...
| INACTIVE | **2485** | 直近証拠なし / 未vet |
| QUALITY 優良 | **231** | WR≥0.5 + PnL≥1000 + n≥20 |
| WEAK | **7** | 低WR / 弱いPnL / ワンショット |

## Data coverage（どの指標か明示）

- `win_rate` filled: **292/2923** (10.0%)
- `realized_pnl*` filled: **438/2923** (15.0%)
- `n_trades*` filled: **292/2923**
- `*_7d` WR filled: **4/2923** (0.1%) ← GMGN 7d 未充足なら lifetime で判定
- `n_trades_7d` filled: **4/2923**
- `last_active*` filled: **0/2923**
- activity_metric breakdown: `{"lifetime_proxy": 434, "n_trades_7d": 4, "unvetted_proxy": 2485}`
