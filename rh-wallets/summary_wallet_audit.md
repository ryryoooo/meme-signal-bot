...
- Updated: **2026-09-21T14:22:43.461331+00:00** (UTC) / JST+9
- Watch: `/home/runner/work/meme-signal-bot/meme-signal-bot/rh-wallets/wallets.jsonl` · total **2684**
- Elapsed: **0.2s** · tagged_rows=93 · RPC=False
...
| INACTIVE | **2251** | 直近証拠なし / 未vet |
| QUALITY 優良 | **227** | WR≥0.5 + PnL≥1000 + n≥20 |
| WEAK | **7** | 低WR / 弱いPnL / ワンショット |

## Data coverage（どの指標か明示）

- `win_rate` filled: **287/2684** (10.7%)
- `realized_pnl*` filled: **433/2684** (16.1%)
- `n_trades*` filled: **287/2684**
- `*_7d` WR filled: **4/2684** (0.1%) ← GMGN 7d 未充足なら lifetime で判定
- `n_trades_7d` filled: **4/2684**
- `last_active*` filled: **0/2684**
- activity_metric breakdown: `{"unvetted_proxy": 2251, "lifetime_proxy": 429, "n_trades_7d": 4}`
