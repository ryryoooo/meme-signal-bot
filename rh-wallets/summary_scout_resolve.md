...
- Updated (UTC): 2026-09-19T22:01:07.164751+00:00
- Unique pairs: **2119/2451** (86.5%)
- Trunc rows still unresolved: **529**
- Methods: pair_cache=1550 token_scoped=0 multi_union=0 mega=1 global=0 two_hit=0
- Blockscout: tokens_fetched=1 nonempty=1 api_fail=0 gmgn_calls=0
- Unresolved reasons (unique pairs): no_token_pool=0 api_fail=0 multi_match=0 no_match=332
...
- no_match total: **332** (huge_pool≥1000 true-dead≈29, mid<500 still deepenable≈279)
...
- `0x1672|f07b` reason=no_match tokens=3 union=464 tier=good
